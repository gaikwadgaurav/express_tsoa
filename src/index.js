...
app.use('/api', swagger_ui_express_1.default.serve, (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    return response.send(swagger_ui_express_1.default.generateHTML(yield Promise.resolve().then(() => __importStar(require('../build/swagger.json')))));
}));
